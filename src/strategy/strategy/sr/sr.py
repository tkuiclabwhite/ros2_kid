...
RIGHT_HAND_X_OFFSET = 0

LEFT_HAND_Y_OFFSET = 600
RIGHT_HAND_Y_OFFSET = -600
# # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
class WallClimbing(API):
    ...
    def get_yaw_value(self):
        if hasattr(self, 'yaw'):
            return self.yaw
        if hasattr(self, 'imu_rpy') and len(self.imu_rpy) >= 3:
            return self.imu_rpy[2]
        return 0.0

    def imu_walk_theta(self):
        yaw = self.get_yaw_value()
