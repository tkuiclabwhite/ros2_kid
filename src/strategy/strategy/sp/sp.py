...
class SP():
    ...
    def status_check(self):
        ...
        if 4000 >= self.sp_ball.size >= 1000:     # 到球前減速
            return 'Decelerating'
        elif self.sp_ball.size > 3000:            # 準備後退（代表球已很靠近）
            return 'Backward'
        return 'Forward'
